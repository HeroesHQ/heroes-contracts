...
near call $BOUNTY_CONTRACT_ID new '{"token_account_ids":["usdn.testnet"],"admins_whitelist":'$ADMIN_ACCOUNT'}' --accountId $BOUNTY_CONTRACT_ID
...
near call usdn.testnet ft_transfer_call '{"receiver_id":"'$BOUNTY_CONTRACT_ID'","amount":"1000000000000000000","msg":"{\"metadata\":{\"title\":\"Test bounty title\",\"description\":\"Test bounty description\",\"category\":\"Design\"},\"deadline\":{\"MaxDeadline\":{\"max_deadline\":\"604800000000000\"}},\"claimer_approval\":\"WithoutApproval\",\"reviewers\":{\"ValidatorsDao\":{\"validators_dao\":{\"account_id\":\"'$DAO_CONTRACT_ID'\",\"add_proposal_bond\":\"1000000000000000000000000\"}}}}"}' --accountId $BASE_ACCOUNT --depositYocto 1 --gas 300000000000000
# Add a bounty under the control of the project owner
#near call usdn.testnet ft_transfer_call '{"receiver_id":"'$BOUNTY_CONTRACT_ID'","amount":"1000000000000000000","msg":"{\"metadata\":{\"title\":\"Test bounty title\",\"description\":\"Test bounty description\",\"category\":\"Design\"},\"deadline\":{\"MaxDeadline\":{\"max_deadline\":\"604800000000000\"}},\"claimer_approval\":\"WithoutApproval\"}"}' --accountId $BASE_ACCOUNT --depositYocto 1 --gas 300000000000000
...
near view $BOUNTY_CONTRACT_ID get_admins_whitelist '{}'
...
near call $DAO_CONTRACT_ID act_proposal '{"id": 0, "action": "VoteApprove"}' --accountId $BASE_ACCOUNT --gas 150000000000000
...
#near call $BOUNTY_CONTRACT_ID bounty_action '{"id":0,"action":{"ClaimApproved":{"receiver_id": "'$FREELANCER_ACCOUNT'"}}}' --accountId $BASE_ACCOUNT --depositYocto 1 --gas 150000000000000
